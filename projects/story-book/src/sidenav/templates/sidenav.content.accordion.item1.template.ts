...
<ng-template #contentAccordion1>
    <mat-accordion multi>
        <mat-expansion-panel expandLink="/item1/group1"  routerLinkActive="active-link">
            <mat-expansion-panel-header>
                <mat-panel-title> Singe</mat-panel-title>
            </mat-expansion-panel-header>
            <mat-accordion multi>
                <mat-expansion-panel expandLink="/item1/group1/subgroup1"  routerLinkActive="active-link">
                    <mat-expansion-panel-header>
                ...
                <mat-expansion-panel expandLink="/group1/subgroup2" routerLinkActive="active-link">
                    <mat-expansion-panel-header>
