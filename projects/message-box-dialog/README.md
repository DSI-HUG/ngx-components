...
```
{
    ...
    "assets": [
        ...
        {
            "input": "node_modules/@hug/ngx-message-box-dialog/src/assets/translations",
            "glob": "**/*",
            "output": "assets/translations/ngx-message-box-dialog"
        }
    ]
}
```
...
```typescript
import { NgxMessageBoxDialogIntl, provideNgxMessageBoxDialog } from '@hug/ngx-user-card';
