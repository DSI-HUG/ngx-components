/* eslint-disable @typescript-eslint/member-ordering, @angular-eslint/prefer-on-push-component-change-detection, @typescript-eslint/naming-convention */
...
export class NavButtonComponent extends NavButton {
    ...
    public override readonly getTheme: Signal<SidebarTheme> = computed(
        () => this.theme() ?? this.sidenav?.theme() ?? SidebarTheme.NONE
    );
